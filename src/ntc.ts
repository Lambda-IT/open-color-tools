...
var ntc = {
    ...
    name: function (color) {
        ...
        for (var i = 0; i < ntc.names.length; i++) {
            ...
            ndf1 = Math.pow(r - <any>ntc.names[i][2], 2) + Math.pow(g - <any>ntc.names[i][3], 2) + Math.pow(b - <any>ntc.names[i][4], 2);
            ndf2 = Math.pow(h - <any>ntc.names[i][5], 2) + Math.pow(s - <any>ntc.names[i][6], 2) + Math.pow(l - <any>ntc.names[i][7], 2);
            ndf = ndf1 + ndf2 * 2;
            if (df < 0 || df > ndf) {
                df = ndf;
                cl = i;
    ...
    hsl: function (color) {
        ...
        return [parseInt(<any>(h * 255)), parseInt(<any>(s * 255)), parseInt(<any>(l * 255))];
    },
